        ...
        <section class="space-y-4">
            ...
            <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                ...
                <label class="space-y-2">
                    ...
                    <input name="risk_score" value="<?= old('risk_score', $customer['risk_score']) ?>" class="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-900">
                </label>
                <label class="space-y-2 md:col-span-2 xl:col-span-3">
