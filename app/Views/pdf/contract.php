...
<body>
    ...
    <table class="report">
        <tbody>
            ...
            <tr><th>Total estimado</th><td colspan="3"><?= esc(money($loan['total_payable'], $loan['currency'])) ?></td></tr>
        </tbody>
    </table>
    ...
    <table class="report">
        <thead>
            <tr><th>Cuota</th><th>Generacion</th><th>Vencimiento</th><th>Total</th></tr>
        </thead>
        <tbody>
